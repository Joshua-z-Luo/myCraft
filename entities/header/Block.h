...
// CAN ONLY PLACE TOP BLOCK CONSISTENTLY IN ONE DIRECTION. (positive X)
...
protected:
    ...
    Vertex baseVertices[24] = {
        ...
        { glm::vec3(1.0f, 1.0f, 0.0f), glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(0.83f, 0.70f, 0.44f), glm::vec2(1.0f, 0.0f) },
